import { ref } from 'vue'
import { downloadJson, cleanHex, getReceivePackets, getSendPacket } from '@/utils/hex'
...
export function useImportExport() {
  ...
  function handleImport(
    content: string,
    onAnalysisLoad: (state: { inputs: InputEntry[]; sendPacket: string; result: AnalysisResult }) => void,
