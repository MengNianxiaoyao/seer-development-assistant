  ...
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        ...
        <div class="modal-dialog w-[500px] max-h-[70vh] relative flex flex-col">
          <div class="bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[70vh]">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-center bg-gradient-to-r from-red-50 to-white flex-shrink-0">
